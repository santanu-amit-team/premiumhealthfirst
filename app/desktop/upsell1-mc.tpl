...
<body class='device-desktop slug-special-o4 page-upsell1 flow-keto-v4'>
    ...
    <main>
        <div class="container">
              ...
              <input type="hidden" name="campaigns[4][id]" value="10">
            ...
            <div id="upsell-box">
                ...
                <div class="coupon-container clearfix" onclick="$('[name=is-upsell]').submit();">
                    ...
                    <div class="bottle-info">
                        ...
                        <p class="line-5"><span class='upsell-msrp'></span> $
                            <?= $get_data['productPrice']['step2_master'][0]->product_price; ?>
                        </p>
                    </div>
                </div>
                <div class="center">
                ...
                <p>*Due to limited inventory levels on any given day, we must limit trial sales to 250 maximum per day. Representations regarding the efficacy and safety of
                    <?= $get_data['productName']['step1'] ?>have not been evaluated by the Food and Drug Administration. The FDA only evaluates foods and drugs, not supplements like these products. These products are not intended to diagnose, prevent, treat, or cure any disease.
                        <br>
