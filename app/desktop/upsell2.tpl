...
<head>
    ...
    <style>
        ...
        .progress .part div:last-child, .progress .bar { background: #a42a5b; }
                    ...
                    .bottle { background-image: url('<?= $path['images'] ?>/upsell_image-2.png?5221549'); }
        ...
        <div class="container">
            ...
            <div id="upsell-box">
                ...
                <div class="center top">
                    ...
                    <p>Customers that purchased <strong><?= $get_data['productName']['step1'] ?></strong> also purchased <strong><?= $get_data['productName']['step3'] ?></strong>
                    </p>
                </div>
                <div class="coupon-container clearfix" onclick="$('[name=is-upsell]').submit();">
                    ...
                    <div class="bottle-info">
                        ...
                        <p class="line-3">with
                            <br><strong><?= $get_data['productName']['step3'] ?></strong>
                        </p>
                        <p class="line-4">Add a <strong>SPECIAL</strong> bottle
                            <br>just pay</p>
