...
<html lang="en">
   <head>
     ...
     <title></title>
      ...
      <link href="<?= $path['css']; ?>/style-index1.css" rel="stylesheet" type="text/css"/>
   ...
   <body>
      ...
      <section id="about-2">
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-6 text-center"><!-- <img src="<?= $path['images']; ?>/images/mag_coverFla_OPT01.png" class="img-fluid"/> --><img src="<?= $path['images']; ?>/images/prodMainFla.png" class="img-fluid" style="width: 200px;"/></div>
            </div>
         </div>
      </section>
      ...
      <section class="key-features">
         ...
         <center><br/><a href="javascript:bookmarkscroll.scrollTo('header')"><button type="button" id="kformSubmit-2-2" class="btn btn-custom btn-small btn-lg kform_submitBtn animated infinite pulse orderNw">RUSH MY ORDER!</button></a></center>
      </section>
