            ...
            .page-checkout, .page-upsell1
{
 ...
 <?php if($customer['cardType']=='master'){?>
            <input type="hidden" name="campaigns[2][id]" value="11">
            <?php }else{ ?>
            <input type="hidden" name="campaigns[2][id]" value="5">
            <?php } ?>
                </form>
                ...
                <div id="upsell-box">
                    ...
                    <div class="coupon-container clearfix" onclick="$('[name=is-upsell]').submit();">
                        ...
                        <div class="bottle-info">
                            ...
                            <p class="line-4">Add a <strong>SPECIAL TRIAL</strong> bottle<br>just pay S&amp;H of</p>

                            <p class="line-5"><span class='upsell-msrp'></span>  $<?= $get_data['shippingPrice']['step2']; ?> </p>
