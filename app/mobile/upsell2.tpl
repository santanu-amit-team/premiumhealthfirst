               ...
               <form name="is-upsell" class="is-upsell" accept-charset="utf-8" enctype="application/x-www-form-urlencoded;charset=utf-8" style="display: none;">
                ...
                <div id="upsell-box">
                    ...
                    <div class="center top">
                        ...
                        <p>Customers that purchased <strong><?= $get_data['productName']['step1'] ?></strong> also purchased <strong><?= $get_data['productName']['step3'] ?></strong></p>
                    ...
                    <div class="coupon-container clearfix" onclick="$('[name=is-upsell]').submit();">
                        ...
                        <div class="bottle-info">
                            ...
                            <p class="line-3">with<br><strong><?= $get_data['productName']['step3'] ?></strong></p>

                            <p class="line-4">Add a <strong>SPECIAL</strong> bottle<br>just pay</p>

                            <p class="line-5"><span class='upsell-msrp'></span>  $29.99 </p>
...
<footer>
  ...
  <div class="footer">
        ...
        <p class="customerservice">
            ...
            Customer Service: <a href="tel:(888) 614-0943">(888) 614-0943</a> </p>
