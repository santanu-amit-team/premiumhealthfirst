...
class M1billing extends BaseCrm { 
    ...
    protected $requiredPayload = array(
        ...
        'newOrderWithProspect' => array(
            ...
            'card_exp_month', 'card_exp_year', 'slug', 'merchant_id'
        ),
        'newOrder' => array(
    ...
    protected function newOrder() {
        ...
        $this->params['offer_id'] = $this->params['products']
                [0]['productId'];
    ...
    private function makeHttpRequest() {
        ...
        $response = Http::post($url, $params, array(), array(CURLOPT_FAILONERROR => false));
