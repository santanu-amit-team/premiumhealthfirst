...
angular.module('codeBaseAdminApp')
        ...
        .controller('CampaignManager', function ($scope, $http, $routeParams, $location, Toast, $rootScope, taOptions, $mdDialog) {
            ...
            $scope.defaultProductArray = function(){
                ...
                'product_schedule' : '', 'product_schedule_quantity' : '', 'product_key' : '', 'nmi_plan_id' : ''};
            };
