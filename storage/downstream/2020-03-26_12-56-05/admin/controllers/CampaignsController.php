...
class CampaignsController
{
    ...
    //     try
    //     {
    //         $data = Database::table('configurations')->findAll()->asArray();
    //         $campaign_ids_val = [];
    //         if (!empty($data))
    //         {
    //             foreach ($data as $data_val)
    //             {
    //                 if (!empty($data_val['campaign_ids']))
    //                 {
    //                     $campaign_ids = json_decode(stripslashes($data_val['campaign_ids']), true);
    //                     if (!empty($campaign_ids))
    //                     {
    //                         foreach ($campaign_ids as $campaign_id)
    //                         {
    //                             $campaign_ids_val[] = $campaign_id;
    //                         }
    //                     }
    //                 }
    //                 if (!empty($data_val['split_campaign_ids']))
    //                 {
    //                     $split_campaign_ids = json_decode(stripslashes($data_val['split_campaign_ids']), true);
    //                     if (!empty($split_campaign_ids))
    //                     {
    //                         foreach ($split_campaign_ids as $split_campaign_id)
    //                         {
    //                             $campaign_ids_val[] = $split_campaign_id;
    //                         }
    //                     }
    //                 }
    //             }
    ...
    //         if (!empty($campaign_ids_val))
    //         {
    //             if (in_array($id, $campaign_ids_val))
    //             {
    //                 $delete_status = false;
    //             }
    //         }
    ...
    //                 'success' => false,
    //                 'data' => array(),
    //                 'error_message' => 'Sorry! This Campaign is already used in Configuration',
    //             );
    //         }
