...
//    }
    ...
    public function updateCampaign() {
        ...
        $payloadCampaignDetails = Config::campaigns((int) $requiredCampaignDetails['alter_campaignid'])[$requiredCampaignDetails['alter_campaignid']];
        CrmPayload::set('campaignId', $payloadCampaignDetails['campaign_id']);
